...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "alipizza_db";
	// Login table name
	private static final String TABLE_LOGIN = "tbl_user";
	// Login Table Columns names
	private static final String KEY_ID = "id"; // ID
	private static final String KEY_EMAIL = "email"; // Email
	private static final String KEY_USERNAME = "uname"; // Username
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_LOGIN + "("
				...
				+ " TEXT UNIQUE," + KEY_USERNAME + " TEXT," + KEY_UID + " TEXT";
